...
import com.luffy.cloud.ali.payment.elasticjobs.configs.properties.JobInstanceProperty;
...
public class ElasticLiteJobConfig {
    ...
    @Bean
    public LiteJobConfiguration insertPaymentJobConfig() throws IllegalArgumentException {
        return getLiteJobConfiguration("insert-payment-job", insertPaymentJob);
    }
